...
export const templateBrandTokensSchema = z.object({
  palette: z
    .object({
      ...
      accent: z.string().default("#E8A84C"),
      accentMuted: z.string().default("#2D2618"),
      accentLight: z.string().default("#1A1922"),
      highlight: z.string().default("#E8A84C"),
      ...
      calloutOrange: z.string().default("#E8A84C"),
    })
    .default({}),
  typography: z
    .object({
...
export const artifactKindSchema = z.enum(["pptx", "pdf", "docx"]);
