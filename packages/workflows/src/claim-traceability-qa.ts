...
function buildClaimTraceabilityPrompt(input: {
  ...
  return [
    ...
    "Recommendation slides are held to the same standard: if the recommendation states an underperformance, demographic target, pricing tier, activation gap, format system, pack/SKU action, launch timing, country/channel action, or retailer-specific action without support, flag it.",
    ...
    "- Unsupported: execution levers such as capsule systems, Nespresso/Dolce Gusto compatibility, pack architecture, SKU renovation, premium importation, Q1/Q2 launch timing, or market-entry sequencing unless those exact ideas appear in the brief, linked sheet, or visible prior evidence slide.",
