...
export async function buildBasquioSystemPrompt(input: {
  ...
  const staticBlock = [
    ...
    "- PROMO STORY CONTRACT: for promo-led briefs, move through category baseline, value vs volume vs price, promo vs no-promo, discount tiers, channel/format/localization, focal brand vs competitor, WD Promo/display/folder mechanics, and only then a short synthesis.",
