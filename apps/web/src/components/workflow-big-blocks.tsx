 ...
 *
 * May 2026 review feedback: the boxes should be "almost the whole page"
 * (wide, prominent), not literally stacked top to bottom. Animate the
 * action, not the text. So this section uses the same sequential cursor
 * pattern Rossella's voice note described, scaled up to a full section
 * after the hero rather than crammed inside it.
 */
    ...
    <section className="workflow-big" aria-labelledby="workflow-big-heading">
      ...
      <div ref={rootRef} className="workflow-big-stage">
        ...
        <Step
          ...
          title="The brief, the data, the notes."
        ...
        <Step
          ...
          title="The brand template, or the Basquio standard."
          body="Cover, dividers, end pages, approved fonts ride straight through to the deliverable."
        ...
        <Step
          ...
          title="The deck, the report, the workbook."
          body="Three files. Numbers reconcile. Editable, sourced, ready to present."
          state={
            downloadClicked
              ? "pressed"
              : downloadReady
