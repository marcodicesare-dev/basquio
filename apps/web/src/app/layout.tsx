...
export const metadata: Metadata = {
  ...
  title: {
    default: "Basquio - The Research Workspace That Remembers",
    template: "%s | Basquio",
  },
  description:
  ...
  openGraph: {
    ...
    description:
      "Keep research material together and turn analyst direction into a deck, report, and Excel file.",
    ...
    },
    {
      ...
      offers: [
        ...
        },
        {
          ...
          description: "One private workspace for recurring research work.",
        },
        {
          "@type": "Offer",
          name: "Team Workspace",
          ...
          priceCurrency: "USD",
          billingIncrement: "P1M",
          description: "Shared memory, projects, onboarding, and pilot support.",
        },
      ],
      featureList: [
        "Brief, data, notes, templates, and past work kept together",
        "Deck output",
        "Narrative report output",
        "Excel workbook output",
        "Chart generation",
        "Workspace memory for recurring research work",
      ],
